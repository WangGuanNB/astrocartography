...
import { getAstrologyHouses6thHousePage } from "@/services/page";
...
const PATH = "/astrology-houses/6th-house";
...
export async function generateMetadata({
  ...
  const page = (await getAstrologyHouses6thHousePage(locale)) as HouseGuidePage;
...
export default async function AstrologyHouses6thHousePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
